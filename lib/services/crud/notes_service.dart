...
class NotesService {
  ...
  Future<DatabaseNote> createNote({required DatabaseUser owner}) async {
    ...
    final noteId = await db.insert(noteTable,
        {userIdColumn: owner.id, textColumn: text, isSyncedWthCloudColumn: 1});
...
class DatabaseNote {
  ...
  DatabaseNote.fromRow(Map<String, Object?> map)
      : id = map[idColumn] as int,
        ...
        isSyncedWithCloud =
            (map[isSyncedWthCloudColumn] as int) == 1 ? true : false;
  @override
  String toString() =>
...
const isSyncedWthCloudColumn = 'is_synced_with_cloud';
